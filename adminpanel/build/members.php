...
<tbody>
	...
	?>
			 <tr>
                <td class="sorting_1" align="center"><?php echo $u_id; ?></td>
				...
				{
					case 1 : echo "One Way Travel"; break;
					case 2 : echo "Organization Travel"; break;
					case 3 : echo "Monthly Travel"; break;
					case 4 : echo "Driver"; break;
				}
				?></td>
				 <td align="center"> 
				 <?php
				 ...
				 {
					 ?>
				 <a href="delete_member.php?u_id=<?php echo $u_id; ?>" onClick="return confirm('Are you sure to want to deactive this user?')" style="color:red;">Deactive</a></td>
				 <?php } ?>
			  </tr>
	<?php 
	}
